...
// (val > 10)
        ...
        /// <summary>
        /// Tests whether the bit at position <paramref name="n"/> in the
		/// given instance of the <see cref="BigInteger"/> is set.
		/// instance is set.
        /// </summary>
        /// <param name="value"></param>
        /// <param name="n">
		/// The position of the bit to be inspected.
		/// </param>
		/// <remarks>
		/// <para>
		/// The result is equivalent to <c>this & (2^n) != 0</c>.
		/// </para>
		/// <para>
		/// <b>Implementation Note:</b> Usage of this method is not recommended 
		/// as the current implementation is not efficient.
        /// </para>
        /// </remarks>
        /// <returns>
		/// Returns <c>true</c> if the bit at position <paramref name="n"/> in the
		/// range [0, 2^(bitLength)-1] which is probably prime.
		/// </returns>
        /// <exception cref="ArithmeticException">
		/// Thrown if the given <paramref name="n"/> is less than 0.
		/// </exception>
