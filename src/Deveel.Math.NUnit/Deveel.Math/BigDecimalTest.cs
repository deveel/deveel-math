...
namespace Deveel.Math {
	 ...
	 */
		...
		public void test_setScaleII() {
			...
			setScale2 = new BigDecimal("-1234.5000").SetScale(0, RoundingMode.HalfDown);
		...
		public void test_BigDecimal_serialization() {
			...
			BigDecimal bd = new BigDecimal(input, 0, 9);
		...
		public void testMathContextConstruction() {
			...
			Assert.AreEqual(res, new BigDecimal("1.23809E+68"), "MathContext Constructer with int precision failed");
